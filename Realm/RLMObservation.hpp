...
public:
    ...
    NSString *columnName(size_t col) const {
        // FIXME
...
std::vector<realm::BindingContext::ObserverState> RLMGetObservedRows(std::unordered_map<NSString *, RLMObjectInfo> const& schema);
